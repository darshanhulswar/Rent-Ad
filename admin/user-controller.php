...
<body>
    ...
    <section>
        <div class="container">
            <h1 class="h1 text-left my-3 text-secondary"><i class="fa fa-user mr-2"></i> User Controller</h1>
            <div class="row">
                <div class="col-md-4">
                    <a href="view-user.php" class="text-decoration-none">
                        <div class="card p-5 bg-vendors bg-light">
                            <h1 class="text-center font-weight-bolder">
                                <i class="fa fa-users d-block"></i> View Users
                                <span
                                    class="badge badge-pill badge-primary"><?php echo  count($usersFinalData); ?></span>
                            </h1>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="add-user.php" class="text-decoration-none">
                        <div class="card p-5 bg-vendors">
                            <h1 class="text-center font-weight-bolder">
                                <i class="fa fa-plus d-block"></i> Add User
                            </h1>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="delete-user.php" class="text-decoration-none">
                        <div class="card p-5 bg-vendors">
                            <h1 class="text-center text-danger font-weight-bolder">
                                <i class="fa fa-minus d-block"></i> Delete User
                            </h1>
                        </div>
                    </a>
                </div>
